---
title: "Going vs Homebase Flights: Scott's Cheap Flights Alternative (2026 Comparison)"
description: "Going costs $49/year but sends deals from 10 airports. Homebase Flights costs $59/year but only YOUR airport. Full comparison of features, pricing, and which is better for you."
date: "2026-02-03"
lastUpdated: "2026-02-18"
category: "tools"
author: "Homebase Flights Team"
image: "https://images.unsplash.com/photo-1529074963764-98f45c47344b?w=1200&h=630&fit=crop"
imageAlt: "Two paths diverging at an airport terminal representing the choice between flight deal services"
featured: false
keywords: ["going vs homebase flights", "scott's cheap flights alternative", "going formerly scott's cheap flights", "homebase flights vs going", "going.com review 2026", "best flight deal service 2026", "going premium worth it", "is scott's cheap flights worth it", "cheap flight newsletter comparison", "flight deal alerts comparison", "going vs scott's cheap flights", "best cheap flight alerts 2026"]
faqs:
  ...
  - question: "What's the main difference between Going and Homebase Flights?"
    answer: "The core difference is airport coverage. Going monitors up to 10 US airports you select ($49/year), sending more total deals but many from airports you may never use. Homebase Flights monitors only your ONE home airport ($59/year), sending fewer emails but ensuring every deal is directly bookable without positioning flights. Going is US-only; Homebase works globally."
  - question: "Which is cheaper, Going or Homebase Flights?"
    answer: "Going Premium costs $49/year (or $199/year for Elite with business class deals). Homebase Flights costs $59/year with a single tier. Going is $10/year cheaper, but Homebase includes a money-back guarantee (3x savings or refund) that Going doesn't offer. The real cost depends on whether you actually book deals—irrelevant deals from distant airports have zero value."
  - question: "Does Homebase Flights work outside the US?"
    answer: "Yes. Unlike Going which only covers US departure airports, Homebase Flights works for major hubs in the US, UK, Europe, Asia, and Australia. If you're based in London, Frankfurt, Singapore, Sydney, or other international cities, Homebase is your only option between these two services."
  - question: "How many emails will I get from each service?"
    answer: "Going Premium subscribers typically receive 10-20+ deals per week across their selected airports. Homebase Flights sends 2-5 deals per week from your single home airport. Going offers more volume; Homebase offers higher relevance per email."
---
...
Consider two travelers: someone based in [Denver](/cheap-flights-from-denver) with one usable airport (DEN) versus someone in the NYC metro area who can realistically use JFK, EWR, LGA, and even [BOS](/cheap-flights-from-boston) or PHL. Their optimal flight deal alert service looks completely different.
...
**Travelers outside the US** who cannot use Going at all. A Scott's Cheap Flights alternative for [London](/cheap-flights-from-london) or [Sydney](/cheap-flights-from-sydney) residents simply doesn't exist in Going's model.
...
* **Based in the US** with realistic access to multiple airports ([NYC metro](/cheap-flights-from-new-york), [LA metro](/cheap-flights-from-los-angeles), [Chicago area](/cheap-flights-from-chicago), [Bay Area](/cheap-flights-from-san-francisco))
