...
const faqs = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 'Homebase Flights costs $5.99/month after a 7-day free trial. Most members save that amount—and much more—on their very first booking. We also offer an annual plan at $59/year for even more savings.',
      },
      {
