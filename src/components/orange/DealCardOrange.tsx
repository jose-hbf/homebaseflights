...
interface DealCardOrangeProps {
  deal: Deal
  showOrigin?: boolean
}

export function DealCardOrange({ deal, showOrigin = false }: DealCardOrangeProps) {
    ...
    <Card className="overflow-hidden hover:shadow-lg transition-all hover:-translate-y-1">
      <div className="p-5">
        ...
        <div className="flex items-baseline gap-2 mb-4">
          <span className="font-serif text-3xl font-semibold text-orange-600">
